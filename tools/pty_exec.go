	...
	return agentic.ToolSchema{
		...
		Schema: map[string]any{
			...
			"properties": map[string]any{
				...
				"action":  map[string]any{"type": "string", "description": "Action: start, write, read, resize, stop, list", "enum": []string{"start", "write", "read", "resize", "stop", "list"}},
				"input":   map[string]any{"type": "string", "description": "Text to write to PTY stdin (for write action)"},
				...
				"tail":    map[string]any{"type": "integer", "description": "Number of lines to read from end (default: all)"},
			},
