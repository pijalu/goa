...
func TestConfigMenu_RootShowsItems(t *testing.T) {
	...
	want := []string{"profile", "model", "provider", "models", "mode", "compression", "theme", "spinner", "thinking_level", "thinking_blocks", "show_thinking", "multi_agent", "orchestrator", "tools", "bash", "mcp", "sandbox", "loop_detection", "skills", "goals"}
