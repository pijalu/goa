...
func TestConfigMenu_RootShowsItems(t *testing.T) {
	...
	want := []string{"profile", "model", "provider", "models", "mode", "retry", "compression", "theme", "spinner", "spinner_location", "thinking_level", "thinking_blocks", "show_thinking", "multi_agent", "orchestrator", "teams", "tools", "bash", "mcp", "sandbox", "loop_detection", "skills", "goals"}
