...
start disabled; use /plugin enable to activate them after reviewing the code.
Activation is permission-gated via the trust system: untrusted plugins must
be approved with /trust:<id> before they can be enabled.
