...
evolution chart plus a table of cache drops (before/after rate) in the current
session, or a turn number for that turn's detailed tree.
...
Examples:
  ...
  /stats:cache    Cache hit-rate evolution + drop table (this session)
